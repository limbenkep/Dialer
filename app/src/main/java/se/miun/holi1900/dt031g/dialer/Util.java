...
public class Util {
    ...
    /**
     * gets the absolut path as a string of a file found in internal storage
     * @param directory parent directory of the file
     * @param fileName name of the file
     * @return absolute path of the file as string
     */
    public static String getVoiceFilePath(File directory, String fileName){
    ...
    public static boolean defaultVoiceExist(Context context) {
        ...
        for (String value : DEFAULT_VOICE_FILE_NAMES.values()) {
